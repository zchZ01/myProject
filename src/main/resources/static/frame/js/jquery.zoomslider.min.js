!function (s) {
    ...
    s.extend(t.prototype, {
        init: function () {
            ...
            }).replace(/^ms-/, "-ms-"), this.transitionProp = {transition: i + " " + this.settings.speed + "ms ease-out, opacity " + this.settings.switchSpeed + "ms"}, this.numSlides = this.settings.src.length, this.$el.css("position")) {
                case"relative":
                case"absolute":
                case"fixed":
                    break;
            ...
            var t = this, e = s('<div class="zs-slideshow"></div>'), n = s('<div class="zs-slides"></div>'),
            ...
            if (e.append(n).prependTo(this.$el), 1 == this.settings.bullets && (e.append(a), e.on("click", ".zs-bullet", function () {
                t.jump(s(this).index())
            ...
            var i = s('<div class="zs-slideshow"></div>'), t = s('<div class="zs-slides"></div>'),
                e = s('<div class="zs-slide zs-slide-0"></div>');
            e.css({"background-image": "url('" + this.settings.src[0] + "')"}).appendTo(t), e.addClass("active").css("opacity", 1), i.append(t).prependTo(this.$el), this.$el.addClass("zs-enabled"), "dots" == this.settings.overlay ? this.$el.addClass("overlay-dots") : "plain" == this.settings.overlay && this.$el.addClass("overlay-plain"), this.support && (e.css("opacity", 0).css(this.transitionProp), setTimeout(function () {
                e.css({opacity: 1, transform: "scale(1.0, 1.0)", "z-index": 2})
            }, 50))
        }, jump: function (s) {
